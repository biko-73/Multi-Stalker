...
url=https://raw.githubusercontent.com/biko-73/Multi-Stalker/main/pro/py3.12/aarch64/MS-1.2-bx.tar.gz
sleep 3
else
url=https://raw.githubusercontent.com/biko-73/Multi-Stalker/main/pro/py3.12/aarch64/MS-1.2-eap.tar.gz
sleep 3
fi;;
*)
echo "> your image python version: $python is not supported"
...
if [[ "$IMAGE" == "openvix" || "$IMAGE" == "openblackhole" ]]; then
url=https://raw.githubusercontent.com/biko-73/Multi-Stalker/main/pro/py3.12/mips/MS-1.2-bx.tar.gz
sleep 3
else
url=https://raw.githubusercontent.com/biko-73/Multi-Stalker/main/pro/py3.12/mips/MS-1.2-eap.tar.gz
sleep 3
fi;;
3.9.9)
url=https://raw.githubusercontent.com/biko-73/Multi-Stalker/main/pro/py3.9/mips/MS-1.2.tar.gz;;
*)
echo "> your image python version: $python is not supported"
sleep 3
exit 1
...
if [[ "$IMAGE" == "openvix" || "$IMAGE" == "openblackhole" ]]; then
url=https://raw.githubusercontent.com/biko-73/Multi-Stalker/main/pro/py3.12/arm/MS-1.2-bx.tar.gz
sleep 3
else
url=https://raw.githubusercontent.com/biko-73/Multi-Stalker/main/pro/py3.12/arm/MS-1.2-eap.tar.gz
sleep 3
fi;;
3.9.9)
url=https://raw.githubusercontent.com/biko-73/Multi-Stalker/main/pro/py3.9/arm/MS-1.2.tar.gz;;
*)
echo "> your image python version: $python is not supported"
sleep 3
exit 1
